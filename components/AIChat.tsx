    ...
    <div className="max-w-4xl mx-auto h-[calc(100vh-180px)] flex flex-col bg-[#1F2937]/30 rounded-[2.5rem] border border-white/10 overflow-hidden backdrop-blur-xl">
      ...
      <div className="p-8 border-t border-white/10 bg-slate-900/50">
        <div className="relative flex items-center">
          ...
          <button 
            onClick={handleSend}
            className="absolute right-3 w-10 h-10 bg-blue-600 rounded-xl flex items-center justify-center text-white hover:scale-105 active:scale-95 transition-all shadow-lg shadow-blue-900/40"
          >
            <Send size={18} />
          </button>
        </div>

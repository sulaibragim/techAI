  ...
  return (
    <div className="space-y-5 pb-24 max-w-5xl mx-auto animate-in fade-in duration-700">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-2">
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-white leading-none uppercase">Client Inbox</h2>
      ...
      <div className="space-y-3 px-2">
        {threads.length === 0 ? (
          <div className="bg-slate-900 rounded-2xl border border-white/10 p-16 flex flex-col items-center justify-center opacity-30 text-center">
            <Smartphone size={40} className="mb-4 text-blue-500" />
            <p className="text-base font-bold uppercase tracking-widest">Inbox Zero</p>
            ...
            >
              ...
              <div className="flex items-center space-x-5 flex-1 min-w-0">
                <div className="w-12 h-12 bg-slate-950 rounded-xl flex items-center justify-center text-blue-500 border border-white/10 shadow-inner relative shrink-0">
                  <User size={20} />
                  <div className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-blue-600 rounded-full border-2 border-[#111827] flex items-center justify-center">
      ...
      {threads.length > 0 && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-2">
           <div className="bg-slate-900 p-4 rounded-2xl border border-white/10 shadow-xl">
              <p className="text-xs font-bold text-gray-700 uppercase tracking-widest mb-2">Response Velocity</p>
              <p className="text-xl font-bold text-white leading-none tracking-tighter">4.2<span className="text-xs text-blue-500 ml-2">min</span></p>
           </div>
           <div className="bg-slate-900 p-4 rounded-2xl border border-white/10 shadow-xl">
              <p className="text-xs font-bold text-gray-700 uppercase tracking-widest mb-2">SLA Compliance</p>
              <p className="text-xl font-bold text-white leading-none tracking-tighter">98<span className="text-xs text-green-500 ml-2">%</span></p>
           </div>
           <div className="bg-slate-900 p-4 rounded-2xl border border-white/10 shadow-xl">
              <p className="text-xs font-bold text-gray-700 uppercase tracking-widest mb-2">Sentiment Index</p>
              <p className="text-xl font-bold text-white leading-none tracking-tighter">Elite</p>
           </div>
        </div>
      )}
    </div>

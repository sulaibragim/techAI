...
export const RULE_QUESTIONS: RuleQuestion[] = [
  ...
  {
    id: "phone-price-is-kept",
    q: "Ты сказал клиенту по телефону «$139 total». На месте техник видит, что работа сложнее. Что будет?",
    options: [
      "Техник назовёт новую цену, и клиент доплатит — работа ведь другая.",
      "Техник откажется от работы, раз цена по телефону была неверной.",
      "Техник один раз спокойно объяснит, но если клиент держится за $139 — сделает за $139.",
      "Техник позвонит менеджеру, и тот уговорит клиента доплатить.",
    ],
    correct: 2,
    why: "Цена с телефона — обещание всей компании: техник не спорит и делает за неё, разницу компания решает потом. Поэтому цену называем только из прайса и точно — ошибка стоит денег.",
  },
];
